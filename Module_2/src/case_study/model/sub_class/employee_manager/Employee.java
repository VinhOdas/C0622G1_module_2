...
public class Employee extends Person {
    ...
    public Employee(String name, String birthDay, String gender, int identityCard, int phoneNumber,
                    String mail, String idEmployee, String level, String location, double wage) {
